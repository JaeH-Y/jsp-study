...
<body>
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-5">
      	<img alt="도서이미지" src="<%= request.getContextPath()%>/images/<%= b.getFilename() %>" style="width: 70%;">
      </div>
      <div class="col-md-6">
      	...
      	<h3><b><%= b.getName() %></b></h3>
				...
				<p>
					<b>도서코드</b>: <span class="badge text-bg-danger"><%= b.getBookId() %></span>
				</p>							
				<p>
					<b>저자</b>: <%= b.getAuthor() %>
				</p>	
				...
				<p><b>분류</b>: <%= b.getCategory() %></p>
				<p><b>재고수</b>: <%= b.getUnitsInStock() %></p>
				<h4><%= b.getUnitPrice() %> 원</h4>
				<p>
